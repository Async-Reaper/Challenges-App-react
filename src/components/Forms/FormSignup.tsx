...
const FormSignup: FC = () => {
  ...
  return (
    <FormWrapper method="POST" onSubmit={(e) => handleSignup(e)}>
      <Input label="First name" value={firstName.value} onChange={firstName.onChange} />
      {firstName.isDirty && firstName.isEmpty && <ErrorText>The field is empty</ErrorText>}
      <Input label="Surname" value={surname.value} onChange={surname.onChange} />
      {surname.isDirty && surname.isEmpty && <ErrorText>The field is empty</ErrorText>}
      <Input label="Username" value={userName.value} onChange={userName.onChange} />
      {userName.isDirty && userName.isEmpty && <ErrorText>The field is empty</ErrorText>}
      <Input label="Email" type="email" value={email.value} onChange={email.onChange} />
      ...
      <Input label="Repeat password" type="password" value={repeatPassword.value} onChange={repeatPassword.onChange} />
